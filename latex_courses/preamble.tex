% ==============================
% Preambolo standard Sapienza Open Notess
% ==============================
...
\usepackage{graphicx}
\usepackage{geometry}
\usepackage{siunitx}      % Per le unità di misura (standard SI)
\usepackage{epigraph}     % Per le citazioni
\usepackage{fancyhdr}     % Per le intestazioni
\usepackage{hyperref}     % Per i link, se necessari

% --- IMPOSTAZIONI DI PAGINA ---
\pagestyle{fancy}
\fancyhf{} % Pulisce tutte le intestazioni e i piè di pagina
\fancyhead[L]{Appunti di Ottica Quantistica}
\fancyfoot[C]{\thepage}
